...
export function createFileStore(root) {
    return {
        ...
        async putPost({ post, cover, markdown }) {
...
export async function listExistingPosts(root) {
