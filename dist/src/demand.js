 ...
 */
export async function duckDuckGoSuggestions(query, timeoutMs = 5000) {
...
export function corroborates(query, suggestions) {
...
export async function hasSecondDemandSignal(query) {
