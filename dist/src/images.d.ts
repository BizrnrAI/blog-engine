 ...
 */
export declare function writeHeroVariants(outDir: string, slug: string, format: BlogEngineConfig['image']['format'], fullBuf: Buffer, fullWidth: number | undefined, publicPath: string): Promise<string>;
