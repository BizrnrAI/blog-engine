...
export async function applyWatermark(root: string, imageBuffer: Buffer): Promise<Buffer> {
...
export async function makeOgCard(root: string, post: GeneratedBlogPost, dryRun = false): Promise<string> {
